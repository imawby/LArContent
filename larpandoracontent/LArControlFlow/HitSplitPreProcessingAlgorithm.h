 ...
 *  $Log: $
 */
#ifndef LAR_HIT_SPLIT_PRE_PROCESSING_ALGORITHM_H
#define LAR_HIT_SPLIT_PRE_PROCESSING_ALGORITHM_H 1
...
/**
 *  @brief  HitSplitPreProcessingAlgorithm class
 */
class HitSplitPreProcessingAlgorithm : public pandora::Algorithm
{
public:
    /**
     *  @brief  Default constructor
     */
    HitSplitPreProcessingAlgorithm();
...
private:
    ...
    void SplitCaloHitList(const pandora::CaloHitList &originalCaloHitList, pandora::CaloHitList &constituentCaloHitList);
...
#endif // #ifndef LAR_HIT_SPLIT_PRE_PROCESSING_ALGORITHM_H
