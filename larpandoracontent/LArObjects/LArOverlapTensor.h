...
public:
    ...
    bool IsInTensor(const pandora::Cluster *const pCluster, const pandora::ClusterSet &clusterSetU, const pandora::ClusterSet &clusterSetV, const pandora::ClusterSet &clusterSetW) const;
