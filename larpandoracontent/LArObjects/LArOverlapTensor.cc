...
template <typename T>
bool OverlapTensor<T>::IsInTensor(const Cluster *const pCluster, const ClusterSet &clusterSetU, const ClusterSet &clusterSetV, const ClusterSet &clusterSetW) const
{
