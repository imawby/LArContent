...
TrackTwoViewTopologyOverlapResult::TrackTwoViewTopologyOverlapResult(const unsigned int nMatchedSamplingPoints, const unsigned int nSamplingPoints,
        const float chi2, const TwoViewXOverlap &xOverlap, const CaloHitList &projectedCaloHits) :
