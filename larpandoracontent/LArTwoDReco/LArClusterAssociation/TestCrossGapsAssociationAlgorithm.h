/**
 *  @file   larpandoracontent/LArTwoDReco/LArClusterAssociation/TestCrossGapsAssociationAlgorithm.h
 *
 *  @brief  Header file for the cross gaps association algorithm class.
 *
 *  $Log: $
 */
#ifndef LAR_TEST_CROSS_GAPS_ASSOCIATION_ALGORITHM_H
#define LAR_TEST_CROSS_GAPS_ASSOCIATION_ALGORITHM_H 1
...
/**
 *  @brief  TestCrossGapsAssociationAlgorithm class
 */
class TestCrossGapsAssociationAlgorithm : public ClusterAssociationAlgorithm
{
public:
    /**
     *  @brief  Default constructor
     */
    TestCrossGapsAssociationAlgorithm();
...
#endif // #ifndef LAR_TEST_CROSS_GAPS_ASSOCIATION_ALGORITHM_H
