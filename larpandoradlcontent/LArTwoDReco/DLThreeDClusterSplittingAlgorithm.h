...
private:
     ...
     */
    void ProcessCluster(const pandora::Cluster *const pCluster, HitKDTree2D &kdTree, pandora::CartesianPointVector &splitPositions);
     ...
     */
    float GetDistanceToSecVertex(const pandora::CaloHit *const pCaloHit) const;
     ...
     *
     *  @param  clusterHits the hits of the considered cluster
     ...
     */
    std::vector<pandora::CaloHitList> DivideCaloHits(const pandora::CaloHitList &clusterHits, const lar_content::TwoDSlidingFitResult &clusterFit, 
...
//------------------------------------------------------------------------------------------------------------------------------------------
     ...
     */
    void FindSplitPositions(const lar_content::TwoDSlidingFitResult &clusterFit, const MCContaminantVector &mcContaminants,
    ...
    float m_isContaminatedThreshold; ///< The threshold score of a contaminated window
    float m_isSplitThreshold;        ///< The threshold score of a predicted split position
